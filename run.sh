...
cp /Skynet-NAS/Nextcloud/html/config/config.php /Skynet-NAS/Nextcloud/html/config/config.php.bak

# Add the LAN IP to the config.php file
awk -v ip="$lan_ip" '/0 => '\''localhost'\''/{print; print "    1 => '\''" ip "'\'',"; next}1' /Skynet-NAS/Nextcloud/html/config/config.php.bak > /Skynet-NAS/Nextcloud/html/config/config.php
